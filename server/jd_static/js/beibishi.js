...
var beibishi = function() {
	...
	var load_problems = function() {
		...
		var probs = [
			...
			["对评测结果有疑义，需要申请复评，则", "提出书面申请", "经领队、有关工作人员、科学委员会主席签字确认", "提交至评测人员", "经教练签字", false, "1", true],
			["复评成绩较原始成绩有变化，则", "以复评成绩为准", "以原始成绩为准", "取两者最高分", "由评测人员决定", false, "1", true],
			["Pascal 中 integer 和 long integer 类型的长度和编译选项是否有关系", "没关系", "有关系", "可能有关系", "可能没关系", false, "1", true],
			...
			["在监考人员宣布 NOI 机试开始之前，是否允许选手登录系统和翻阅试卷", "是", "否", "可能允许", "可能不允许", false, "1", true],
			...
			["第 12 届IOI是哪一年在北京举办的", "2000", "1984", "1985", "2017", "1", true]
		];
		all_probs = [];
