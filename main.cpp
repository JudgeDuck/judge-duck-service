...
QString judgeFile(string language)
{
	...
	if(system("ld -o judging -T ../judgeduck.ld -m elf_i386 -nostdlib contestant.o tasklib.o ../libtaskduck/libtaskduck.a ../libjudgeduck/libjudgeduck.a ../libstdduck/libstdduck.a libopenlibm.a /usr/lib/gcc/i686-linux-gnu/5/libgcc.a > ld.log 2>&1"))
